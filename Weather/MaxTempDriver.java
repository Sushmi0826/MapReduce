...
public class MaxTempDriver {
    ...
    job.setJarByClass(MaxTempDriver.class);  //Assigning the driver class name
    ...
    job.setMapperClass(MaxTempMapper.class);  		//Defining the mapper class name
    
    job.setReducerClass(MaxTempReducer.class);  		//Defining the reducer class name
